...
describe('Department e2e test', () => {
    ...
    it('should create and save Departments', () => {
        departmentComponentsPage.clickOnCreateButton();
        departmentDialogPage.setDepartmentIdInput('5');
        expect(departmentDialogPage.getDepartmentIdInput()).toMatch('5');
...
export class DepartmentDialogPage {
    ...
    departmentIdInput = element(by.css('input#field_departmentId'));
    ...
    setDepartmentIdInput = function (departmentId) {
        this.departmentIdInput.sendKeys(departmentId);
    }

    getDepartmentIdInput = function () {
        return this.departmentIdInput.getAttribute('value');
    }
