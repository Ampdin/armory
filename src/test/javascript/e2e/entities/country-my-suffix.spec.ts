...
describe('Country e2e test', () => {
    ...
    it('should create and save Countries', () => {
        countryComponentsPage.clickOnCreateButton();
        countryDialogPage.setCountryIdInput('5');
        expect(countryDialogPage.getCountryIdInput()).toMatch('5');
...
export class CountryDialogPage {
    ...
    countryIdInput = element(by.css('input#field_countryId'));
    ...
    setCountryIdInput = function (countryId) {
        this.countryIdInput.sendKeys(countryId);
    }

    getCountryIdInput = function () {
        return this.countryIdInput.getAttribute('value');
    }
