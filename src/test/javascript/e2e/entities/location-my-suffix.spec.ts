...
describe('Location e2e test', () => {
    ...
    it('should create and save Locations', () => {
        locationComponentsPage.clickOnCreateButton();
        locationDialogPage.setLocationIdInput('5');
        expect(locationDialogPage.getLocationIdInput()).toMatch('5');
...
export class LocationDialogPage {
    ...
    locationIdInput = element(by.css('input#field_locationId'));
    ...
    setLocationIdInput = function (locationId) {
        this.locationIdInput.sendKeys(locationId);
    }

    getLocationIdInput = function () {
